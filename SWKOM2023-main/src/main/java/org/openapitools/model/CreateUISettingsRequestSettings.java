...
public class CreateUISettingsRequestSettings {
  ...
  */
  @NotNull @Valid 
  @Schema(name = "update_checking", required = false)
  ...
  */
  @NotNull 
  @Schema(name = "tour_complete", required = false)
  ...
  */
  @NotNull @Valid 
  @Schema(name = "bulk_edit", required = false)
  ...
  */
  @NotNull 
  @Schema(name = "documentListSize", required = false)
  ...
  */
  @NotNull 
  @Schema(name = "slim_sidebar", required = false)
  ...
  */
  @NotNull @Valid 
  @Schema(name = "dark_mode", required = false)
  ...
  */
  @NotNull @Valid 
  @Schema(name = "theme", required = false)
  @JsonProperty("theme")
  ...
  */
  @NotNull @Valid 
  @Schema(name = "document_details", required = false)
  ...
  */
  @NotNull @Valid 
  @Schema(name = "date_display", required = false)
  ...
  */
  @NotNull 
  @Schema(name = "notes_enabled", required = false)
  ...
  */
  @NotNull @Valid 
  @Schema(name = "saved_views", required = false)
