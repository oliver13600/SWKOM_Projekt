...
public class SelectionData200Response {
  ...
  */
  @NotNull @Valid 
  @Schema(name = "selected_correspondents", required = false)
  ...
  */
  @NotNull @Valid 
  @Schema(name = "selected_tags", required = false)
  ...
  */
  @NotNull @Valid 
  @Schema(name = "selected_document_types", required = false)
  ...
  */
  @NotNull @Valid 
  @Schema(name = "selected_storage_paths", required = false)
