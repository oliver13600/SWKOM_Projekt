...
public class CreateUISettingsRequestSettingsNotifications {
  ...
  */
  @NotNull 
  @Schema(name = "consumer_new_documents", required = false)
  ...
  */
  @NotNull 
  @Schema(name = "consumer_success", required = false)
  ...
  */
  @NotNull 
  @Schema(name = "consumer_failed", required = false)
  ...
  */
  @NotNull 
  @Schema(name = "consumer_suppress_on_dashboard", required = false)
