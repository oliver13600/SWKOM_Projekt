...
public class GetTasks200ResponseInner {
  ...
  */
  @NotNull 
  @Schema(name = "task_id", required = false)
  ...
  */
  @NotNull 
  @Schema(name = "task_file_name", required = false)
  ...
  */
  @NotNull 
  @Schema(name = "date_created", required = false)
  ...
  */
  @NotNull 
  @Schema(name = "acknowledged", required = false)
