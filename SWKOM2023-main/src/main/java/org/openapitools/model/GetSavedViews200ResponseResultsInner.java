...
public class GetSavedViews200ResponseResultsInner {
  ...
  */
  @NotNull 
  @Schema(name = "show_on_dashboard", required = false)
  ...
  */
  @NotNull 
  @Schema(name = "show_in_sidebar", required = false)
  ...
  */
  @NotNull 
  @Schema(name = "sort_field", required = false)
  ...
  */
  @NotNull 
  @Schema(name = "sort_reverse", required = false)
  ...
  */
  @NotNull @Valid 
  @Schema(name = "filter_rules", required = false)
