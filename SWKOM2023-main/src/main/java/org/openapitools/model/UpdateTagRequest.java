...
public class UpdateTagRequest {
  ...
  */
  @NotNull 
  @Schema(name = "text_color", required = false)
  ...
  */
  @NotNull 
  @Schema(name = "match", required = false)
  @JsonProperty("match")
  ...
  */
  @NotNull 
  @Schema(name = "matching_algorithm", required = false)
  ...
  */
  @NotNull 
  @Schema(name = "is_insensitive", required = false)
  ...
  */
  @NotNull 
  @Schema(name = "is_inbox_tag", required = false)
  ...
  */
  @NotNull 
  @Schema(name = "document_count", required = false)
  ...
  */
  @NotNull @Valid 
  @Schema(name = "permissions_form", required = false)
