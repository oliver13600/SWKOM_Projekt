...
public class Statistics200Response {
  ...
  */
  @NotNull 
  @Schema(name = "documents_total", required = false)
  ...
  */
  @NotNull 
  @Schema(name = "documents_inbox", required = false)
  ...
  */
  @NotNull 
  @Schema(name = "inbox_tag", required = false)
  ...
  */
  @NotNull @Valid 
  @Schema(name = "document_file_type_counts", required = false)
  ...
  */
  @NotNull 
  @Schema(name = "character_count", required = false)
