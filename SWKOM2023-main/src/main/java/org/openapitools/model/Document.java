...
import org.openapitools.services.dto.BaseDTO;
...
public class Document extends BaseDTO {
  ...
  */
  ...
  @Schema(name = "correspondent", required = false)
  ...
  */
  ...
  @Schema(name = "document_type", required = false)
  ...
  */
  ...
  @Schema(name = "storage_path", required = false)
  ...
  */
  @Valid 
  @Schema(name = "created_date", required = false)
  ...
  */
  ...
  @Schema(name = "archive_serial_number", required = false)
  ...
  */
  ...
  @Schema(name = "original_file_name", required = false)
  ...
  */
  ...
  @Schema(name = "archived_file_name", required = false)
