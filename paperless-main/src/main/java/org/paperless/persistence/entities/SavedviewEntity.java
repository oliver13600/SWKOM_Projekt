...
public class SavedviewEntity {
    ...
    private Set<SavedviewfilterruleEntity> savedViewSavedviewfilterruleEntities;
    ...
    public Set<SavedviewfilterruleEntity> getSavedViewDocumentsSavedviewfilterrules() {
        return savedViewSavedviewfilterruleEntities;
    }

    public void setSavedViewDocumentsSavedviewfilterrules(
            final Set<SavedviewfilterruleEntity> savedViewSavedviewfilterruleEntities) {
